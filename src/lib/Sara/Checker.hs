...
checkWithoutMain :: Program a b c ParserNodeMeta -> ErrorOr ()
checkWithoutMain = checkProgram

checkWithMain :: Program a b c ParserNodeMeta -> ErrorOr ()
checkWithMain p = checkMain p >> checkProgram p

checkMain :: Program a b c ParserNodeMeta -> ErrorOr ()
...
checkProgram :: Program a b c ParserNodeMeta -> ErrorOr ()
checkProgram p = checkSignatures p >> checkAssignments p

checkSignatures :: Program a b c ParserNodeMeta -> ErrorOr ()
...
checkAssignments :: Program a b c ParserNodeMeta -> ErrorOr ()
